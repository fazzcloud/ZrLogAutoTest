...
if __name__ == '__main__':
    ...
    red = find({"id":"${id_name}","editorType":"markdown","title":"付出才能杰出","alias":"${alias_name}","thumbnail":None,"typeId":"1","keywords":None,"digest":"<p>付出</p>","canComment":False,"recommended":False,"privacy":False,"content":"<p>付出</p>\n","markdown":"付出","rubbish":False})
    print(red)